...
/*
 * camrtc-capture-messages-r32.h
 *
 * L4T r32 (JetPack 4) RCE capture IVC message ABI.  Verbatim copy of the r32
 * kernel/nvidia/include/soc/tegra/camrtc-capture-messages.h with the include
 * guard renamed and the camrtc-capture include redirected to the r32 header.
 *
 * The single most important difference vs r35:
 *   CAPTURE_CHANNEL_SETUP_REQ  r32 = 0x10   r35 = 0x1E
 * r35 renamed 0x10 to CAPTURE_CONTROL_RESERVED_10, so an r35 kernel talking
 * to r32 firmware is simply not understood.
 */
/*
...
#ifndef INCLUDE_CAMRTC_CAPTURE_MESSAGES_R32_H
#define INCLUDE_CAMRTC_CAPTURE_MESSAGES_R32_H
...
#endif /* INCLUDE_CAMRTC_CAPTURE_MESSAGES_R32_H */
