#!/bin/bash
# =============================================================================
#  变体 AC —— AB + Stage-23：VI 侧也补 nvhost 上电（A/B 表最后一条）
#
...
OUT=/tmp/kb
DEST=/work/nvcsi-variants/AC-vipwr
...
for s in r32_camera_power r32-stage2 r32-csi5 r32-vi5 r32-sync r32-mipical r32-mipisoc r32-settle r32-csistart r32-padcfg r32-recal r32-csipwr r32-vipwr tegra194_nvcsi_r32_start_streams tegra_camrtc_r32_camera_power_enabled nvcsi-t194-prod; do
