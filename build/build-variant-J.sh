#!/bin/bash
# =============================================================================
#  变体 J —— I + 描述符 dma_sync(路线B：v4l2 内核内部路径补可见性)
#
...
OUT=/tmp/kb
DEST=/work/nvcsi-variants/J-stage5
...
for s in r32_camera_power r32-stage2 r32-csi5 r32-vi5 r32-sync tegra_camrtc_r32_camera_power_enabled nvcsi-t194-prod; do
