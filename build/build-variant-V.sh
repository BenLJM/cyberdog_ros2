#!/bin/bash
# =============================================================================
#  变体 V —— T + Stage-16：CSI 消息改成申请 trans_id + 等应答 + 查返回码
#
...
OUT=/tmp/kb
DEST=/work/nvcsi-variants/V-csiresp
...
for s in r32_camera_power r32-stage2 r32-csi5 r32-vi5 r32-sync r32-mipical r32-mipisoc r32-settle r32-csistart r32-resp tegra194_nvcsi_r32_start_streams tegra_camrtc_r32_camera_power_enabled nvcsi-t194-prod; do
