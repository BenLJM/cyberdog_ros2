#!/bin/bash
# =============================================================================
#  变体 Y —— T + Stage-19：补齐 csi5_mipi_cal 的 CIL pad 配置 + SW reset
#
...
OUT=/tmp/kb
DEST=/work/nvcsi-variants/Y-padcfg
...
for s in r32_camera_power r32-stage2 r32-csi5 r32-vi5 r32-sync r32-mipical r32-mipisoc r32-settle r32-csistart r32-padcfg tegra194_nvcsi_r32_start_streams tegra_camrtc_r32_camera_power_enabled nvcsi-t194-prod; do
