#!/bin/bash
# =============================================================================
#  变体 AB —— AA + Stage-22：开流前补 CSI 的 nvhost 上电
#
...
OUT=/tmp/kb
DEST=/work/nvcsi-variants/AB-csipwr
...
for s in r32_camera_power r32-stage2 r32-csi5 r32-vi5 r32-sync r32-mipical r32-mipisoc r32-settle r32-csistart r32-padcfg r32-recal r32-csipwr tegra194_nvcsi_r32_start_streams tegra_camrtc_r32_camera_power_enabled nvcsi-t194-prod; do
