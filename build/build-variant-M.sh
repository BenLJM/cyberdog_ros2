#!/bin/bash
# =============================================================================
#  变体 M —— L + Stage-8：cil_settletime 由内核补算
#
...
OUT=/tmp/kb
DEST=/work/nvcsi-variants/M-settle
...
for s in r32_camera_power r32-stage2 r32-csi5 r32-vi5 r32-sync r32-mipical r32-mipisoc r32-settle tegra_camrtc_r32_camera_power_enabled nvcsi-t194-prod; do
