#!/bin/bash
# =============================================================================
#  变体 O —— N + Stage-10：把 settle time 补算挪到 stage3 的 R32 路径上
#
...
OUT=/tmp/kb
DEST=/work/nvcsi-variants/O-settle2
...
for s in r32_camera_power r32-stage2 r32-csi5 r32-vi5 r32-sync r32-mipical r32-mipisoc r32-settle r32-csistart tegra_camrtc_r32_camera_power_enabled nvcsi-t194-prod; do
