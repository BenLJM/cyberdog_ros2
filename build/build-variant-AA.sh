#!/bin/bash
# =============================================================================
#  变体 AA —— Z + Stage-21：补回出厂 DTB 里有、我们缺的三个属性
#
...
OUT=/tmp/kb
DEST=/work/nvcsi-variants/AA-dtprops
...
for s in r32_camera_power r32-stage2 r32-csi5 r32-vi5 r32-sync r32-mipical r32-mipisoc r32-settle r32-csistart r32-padcfg r32-recal tegra194_nvcsi_r32_start_streams tegra_camrtc_r32_camera_power_enabled nvcsi-t194-prod; do
