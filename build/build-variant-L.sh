#!/bin/bash
# =============================================================================
#  变体 L —— K + Stage-7：恢复 T194 的 MIPI 校准 SoC ops
#
...
OUT=/tmp/kb
DEST=/work/nvcsi-variants/L-mipisoc
...
for s in r32_camera_power r32-stage2 r32-csi5 r32-vi5 r32-sync r32-mipical r32-mipisoc tegra_camrtc_r32_camera_power_enabled nvcsi-t194-prod; do
